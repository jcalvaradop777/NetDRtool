...
public DDRmix1(double[][] Xin, double[][] K1, double[][] K2, float R, float B, int d){
    ...
    try {
        ...
        double[][] C = Matriz.Multiplicar(Xt,KM);
...
//        vectores = getEigVectores();
        ...
        Logger.getLogger(DDRmix1.class.getName()).log(Level.SEVERE, null, ex);
    }
}

public DDRmix1(double[][] Xin, double[][] K1, double[][] K2, double[][] K3, float R, float G, float B, int d){
