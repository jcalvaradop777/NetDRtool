...
// TODO add your handling code here:
        ...
        Apriori a = new Apriori(dataset, support, new AssociationIcon(new JLabel(),0,0,0));
...
//                new Short(txtSupport.getText()) / 100);
        ...
        EquipAsso equi = new EquipAsso(dataset, support,new AssociationIcon(new JLabel(),0,0,0));
        int type = 2;
...
//                new Short(txtSupport.getText()) / 100);
        ...
        //dataset.showNTree();
        FPGrowth arbol = new FPGrowth(dataset, support,new AssociationIcon(new JLabel(),0,0,0));
        arbol.buildTree();
        //arbol.goToRoot();
