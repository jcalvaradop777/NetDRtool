 ...
 */
public class HelpNumericRange extends javax.swing.JFrame {
    
    /**
     * Creates new form HelpNumericRange
     */
    public HelpNumericRange() {
        initComponents();
        ...
        jTextArea9.setText(java.util.ResourceBundle.getBundle("resource/translations/FiltersHelp").getString("H"));
        jTextArea10.setText(java.util.ResourceBundle.getBundle("resource/translations/FiltersHelp").getString("I"));
        jTextArea11.setText(java.util.ResourceBundle.getBundle("resource/translations/FiltersHelp").getString("J"));
        jLabel19.setText(java.util.ResourceBundle.getBundle("resource/translations/FiltersHelp").getString("Filter_Numeric_Range"));
        jTextArea12.setText(java.util.ResourceBundle.getBundle("resource/translations/FiltersHelp").getString("K"));
    }
    ...
    private void initComponents() {
        ...
        jTextArea9.setText("El objetivo espec\u00edfico de este filtro, es eliminar los valores de un\natributo num\u00e9rico, que est\u00e1n por fuera de un rango determinado \npor el analista, reemplaz\u00e1ndolos con valores nulos. \n\nla conexion con otros componentes drag and drop, es similar \nen todos los filtros, y se realiza como se muestra a continuacion. ");
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Help/RemoveMissingA")));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Help/visualisacion")));
        jLabel18.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jTextArea11.setColumns(20);
        jTextArea11.setRows(5);
        jTextArea11.setText("Aparece la ventana de vizualizacion de datos \ufb01ltrados y no \ufb01ltrados. \n\nLos campos son:\n\nA: Variables o nombres de los campos de la tabla. \nB: Datos de entrada que son los datos que llegaron al \ufb01ltro inicialmente.\nC: Datos \ufb01ltrados que son el resultado de haber aplicado el \ufb01ltro. \nD: nmero de registros eliminados al aplicar el \ufb01ltro.\nE: Numero de registros despues de aplicar el \ufb01ltro.\n");

        jLabel19.setFont(new java.awt.Font("Dialog", 1, 24));
        jLabel19.setText("Filter Numeric Range");

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Help/visualisacion 2")));
        jLabel20.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Help/confNumericRange")));
        jLabel21.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jTextArea12.setColumns(20);
        jTextArea12.setRows(5);
        jTextArea12.setText("Al acceder a la opcion de configuracion se muestra B la ventana de\ncon\ufb01guracin correspondiente al \ufb01ltro \u2019Numeric Range\u2019. Los campos son: \n\nAtributo, en el cual se escribe el nombre del atributo a discretizar \nde tipo num\u00e9rico. \n\nReemplazar rango con valores nulos:  aqui es posible especi\ufb01car \nun rango de datos que seran convertidos a n\u00falos. \n\nM\u00edmimo valor: l\u00edmite inferiror del rango. \n\nMaximo valor: l\u00edmite superior del rango. Aplicar: ejecuta el \ufb01ltro. \n\nResetear: deja los campos en blanco.\n\n\nPara visualizar los resultados obtenidos, hacemos uso de la opcion view\nmostrando una interfaz como la siguiente:\n\n\n");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jTextArea12, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 184, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jLabel18)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jLabel20)
