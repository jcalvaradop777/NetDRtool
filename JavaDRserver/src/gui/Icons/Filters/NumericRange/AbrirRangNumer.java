...
public class AbrirRangNumer extends javax.swing.JFrame {
    ...
    public AbrirRangNumer(AbstractTableModel dataIn) {
        ...
        for(int i = 0; i < datosEntrada.getColumnCount(); i++) {
            if(datosEntrada.getColumnClass(i).getSimpleName().equals("Integer") || datosEntrada.getColumnClass(i).getSimpleName().equals("Double")) {
    ...
    private void initComponents() {
        ...
        jLayeredPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Remplace range whit null values", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(185, 220, 255))); // NOI18N
        ...
        jLabel3.setBounds(190, 30, 90, 20);
