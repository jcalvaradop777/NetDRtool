...
/*
 * miVerRangoNumerico.java
 *
 * Created on 25-may-2012, 14:10:17
 */
 ...
 * @author Juan Carlos
 */
public class miVerRangoNumerico extends javax.swing.JFrame {
    AbstractTableModel datosEntrada;
    AbstractTableModel tipoVariables;
    AbstractTableModel datosFiltros;

    /** Creates new form miVerRangoNumerico */
    public miVerRangoNumerico(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
//                new miVerRangoNumerico().setVisible(true);
            }
        });
    }
