...
/*
 * miVerResRemMiss.java
 *
 * Created on 25-may-2012, 14:36:43
 */
 ...
 * @author Juan Carlos
 */
public class miVerResRemMiss extends javax.swing.JFrame {
    ...
    public miVerResRemMiss(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
    ...
    public void setDatas(AbstractTableModel din, AbstractTableModel dout) {
        ...
        datosFiltros = ((RemplazarMissing)dout).dataOut;
        LblRegAct.setText(Integer.toString(datosFiltros.getRowCount()));
        LblRegElim.setText(Integer.toString(/*datosFiltros*/((RemplazarMissing)dout).getNMissing()));
