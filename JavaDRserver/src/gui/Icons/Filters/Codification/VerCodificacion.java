 ...
 * @author  Tariy
 */
public class VerCodificacion extends javax.swing.JFrame {
    ...
    public VerCodificacion(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Dictionary", jScrollPane4);
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/save_all.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new VerCodificacion().setVisible(true);
            }
        });
    }
