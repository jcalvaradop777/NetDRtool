 ...
 * @author  Tariy
 */
public class VerMuestra extends javax.swing.JFrame {
    ...
    public VerMuestra(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new VerMuestra().setVisible(true);
            }
        });
    }
