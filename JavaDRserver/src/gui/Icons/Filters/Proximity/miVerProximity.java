 ...
 * @author Juan Carlos
 */
public class miVerProximity extends javax.swing.JFrame {
    
    AbstractTableModel datosEntrada;
    AbstractTableModel tipoVariables;
    AbstractTableModel datosFiltros;
    
    /** Creates new form miVerResRemMiss */
    public miVerProximity(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
        tipoVariables = new TipodVariables(dataIn);
//        datosFiltros = ((Proximity)dataOut).dataOut;
        initComponents();
        LblRegAct.setText(Integer.toString(datosFiltros.getRowCount()));
//        LblRegElim.setText(Integer.toString(/*datosFiltros*/((Proximity)dataOut).getNMissing()));
    }

    
    public miVerProximity() {
        initComponents();
    }
    
    public void setDatas(AbstractTableModel din, AbstractTableModel dout) {
        datosEntrada = din;
    ...
    private void initComponents() {
        ...
        jScrollPane3.setToolTipText("Type of Variable");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
//                new miVerResRemMiss().setVisible(true);
            }
        });
    }
