 ...
 * @author  Tariy
 */
public class HelpSelection extends javax.swing.JFrame {
    
    /** Creates new form frmCredits */
    public HelpSelection() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jLabel7)
                .add(15, 15, 15)
                .add(jTextArea5, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 319, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(17, 17, 17)
                .add(jLabel4)
                .add(18, 18, 18)
                .add(jLabel5)
