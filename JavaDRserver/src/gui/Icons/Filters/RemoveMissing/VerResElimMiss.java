 ...
 * @author Tariy
 */
public class VerResElimMiss extends javax.swing.JFrame {
    ...
    public VerResElimMiss(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new VerResElimMiss().setVisible(true);
            }
        });
    }
