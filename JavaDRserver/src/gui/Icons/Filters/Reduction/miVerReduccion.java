 ...
 * miVerReduccion.java
 *
 * Created on 25-may-2012, 9:38:43
 */
 ...
 * @author Juan Carlos
 */
public class miVerReduccion extends javax.swing.JFrame {

    AbstractTableModel datosEntrada;
    AbstractTableModel tipoVariables;
    AbstractTableModel datosFiltros;
    
    /** Creates new form miVerReduccion */
    public miVerReduccion(AbstractTableModel dataIn, AbstractTableModel dataOut) {
        datosEntrada = dataIn;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(saveOK == Save.APPROVE_OPTION) {
            ...
            fm.writeString(textFilter.toString());JOptionPane.showMessageDialog(this, "Filtered data successfully saved", "VisMineKDD", JOptionPane.INFORMATION_MESSAGE);
