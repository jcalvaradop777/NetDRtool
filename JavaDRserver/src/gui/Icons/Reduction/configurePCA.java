 ...
 * @author Juan Carlos
 */
public class configurePCA extends javax.swing.JFrame {

    DRIcon dri;
    /** Creates new form configureSupport */
    
    public configurePCA(DRIcon icon) {
        initComponents();
        dri = icon;
    }
    ...
    private void initComponents() {
        ...
        cmbCor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Covariance", "Correlation" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cmbCor, 0, 96, Short.MAX_VALUE))
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        dri.d = dr;
        dri.cor = cmbCor.getSelectedIndex() != 0;
        ChooserEscritorio.setStatus("Selected method for " + dri.algorithm + " is " + cmbCor.getSelectedItem().toString() + "%");
