 ...
 *******************************************************************************/
package Utils.MachineLearning.math.math;
...
import Utils.MachineLearning.math.math.matrix.IMatrix;
import Utils.MachineLearning.math.math.matrix.LUDecomposition;
import Utils.MachineLearning.math.math.matrix.Matrix;
import Utils.MachineLearning.math.math.matrix.QRDecomposition;
import Utils.MachineLearning.math.math.matrix.SingularValueDecomposition;
import Utils.MachineLearning.math.sort.QuickSelect;
import Utils.MachineLearning.math.sort.QuickSort;
import Utils.MachineLearning.math.sort.SortUtils;
...
public class Math {
     ...
     */
    private static ThreadLocal<Utils.MachineLearning.math.math.Random> random = new ThreadLocal() {
        protected synchronized Object initialValue() {
            if (Thread.currentThread().getName().equals("run-main-0")) {
                ...
                return new Utils.MachineLearning.math.math.Random();
            } else {
                ...
                return new Utils.MachineLearning.math.math.Random(seed);
            }
        }
    };
